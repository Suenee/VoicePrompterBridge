...
namespace VPBridgeTray
{
 ...
 internal sealed class LoggingConfig {public bool enabled{get;set;}=true;public string directory{get;set;}="./logs";public int retentionMinutes{get;set;}=60;}
}
